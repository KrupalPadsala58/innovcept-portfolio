    ...
    <footer className="bg-primary text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            ...
            <p className="text-gray-300 max-w-xs">
              Building modern, scalable, and user-friendly web applications for businesses worldwide.
            </p>
          </div>
          ...
          <div>
            <h4 className="text-lg font-semibold mb-4 text-highlight">Connect</h4>
            <div className="flex space-x-4 mb-4">
              <a href="#" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-highlight transition-colors">
                 {/* LinkedIn Icon */}
        ...
        <div className="border-t border-gray-700 pt-8 text-center text-gray-400 text-sm">
           © {new Date().getFullYear()} Innovcept. All rights reserved.
        </div>
      </div>
    </footer>
  );
